...
Started: YYYY-MM-DD  
Current focus: <main focus right now>  
Current level: beginner | early-intermediate | intermediate | advanced | custom  
Review cadence: weekly | biweekly | monthly | as-needed

---

## 1. Purpose

<Why this domain exists in the framework.>

Example:

This domain exists to build practical and conceptual skill in <topic>, so I can use it in <projects/career/long-term goals>.
...
- <related but intentionally deferred area>
...
|---|---|---|---|
| <item> | project / note / experiment / resource | planned / active / done | <link> |
